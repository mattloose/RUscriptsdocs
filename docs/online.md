...
** Important: If you are using minKNOW 0.51.3 or greater then the port (-p) option should be set to 8001. You should also only start read until AFTER THE MUX SCAN IS COMPLETE.
