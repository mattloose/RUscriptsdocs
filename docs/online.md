...
An example run of gReadUntil.py:
    ...
    > python gReadUntil.py -f ..\J02459.fasta -targets J02459:10000-20000 J02459:30000-45000 -procs 8 -t 100 -m C:\grouper\binaries\conf\synthesis\model.txt -ip 127.0.0.1 -p 9200 -length 1000
...
![An image showing the live gReadUntil ONT workflow](images/livegReadUntil.jpg)
...
The run:
    ...
    > python gReadUntil.py -f ..\J02459.fasta -targets J02459:10000-20000 J02459:30000-45000 -procs 8 -t 100 -m ..\template_r7.3_e6_70bps_6mer_6.model -ip 127.0.0.1 -p 9200 -length 1000
...
![An image showing the live amplicon balancing workflow](images/liveaReadUntil.jpg)
